...
import z from 'zod'
import { getRoutine, updateRoutine } from '../../api/routine'
...
async function fetchRoutine() {
    ...
    if (success) { 
        routineData.value = {
            name: data.name,
            exercises: data.exercises.map((ex: { exercise: { _id: any; name: any }; sets: any; reps: any }) => ({
...
async function submitForm() {
    ...
    const { success, error } = await updateRoutine(id, routineData.value)
